  ...
  return (
    <Box className="max-w-screen-lg mx-auto p-5">
      <Box className="grid grid-cols-1 md:grid-cols-12 border">
        <Box className="bg-ppl md:col-span-4 p-10 text-white animate__animated animate__fadeInLeft">
        ...
        <form className="md:col-span-8 p-10 animate__animated animate__fadeInRight">
