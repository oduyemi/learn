            ...
            <Box>
                <Box className="bg-ppl text-white relative shadow rounded-lg w-5/6 md:w-5/6  lg:w-4/6 xl:w-3/6 mx-auto">
                    <Box className="flex justify-center">
                            <img src={require("../assets/images/photos/avatar.png")} alt="" className="rounded-full mx-auto absolute -top-20 w-32 h-32 shadow-md border-4 border-white transition duration-200 transform hover:scale-110" />
                    </Box>
                    
                    <Box className="mt-16">
                        <h1 className="font-bold text-center text-3xl text-gray-200">First name Last name</h1>
                        <p className="text-center text-sm text-gray-400 font-medium">username</p>
                        <p>
                            <span>
