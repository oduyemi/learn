...
export const WhatWeDo = () => {
    return(
        <Box className="bg-ppl">
            <section id="features"
                className="relative block px-6 py-10 md:py-20 md:px-10  border-t border-b border-neutral-900 bg-neutral-900/30">


                <Box className="relative mx-auto max-w-5xl text-center">
                ...
                <Box className="relative mx-auto max-w-7xl z-10 grid grid-cols-1 gap-10 pt-14 sm:grid-cols-2 lg:grid-cols-3">
                    <Box className="rounded-md border border-neutral-800 bg-yel/50 p-8 text-center shadow">
                        <h3 className="mt-6 head text-2xl text-gray-200">Innovation Hub</h3>
                    ...
                    <Box className="rounded-md border border-neutral-800 bg-yel/50 p-8 text-center shadow">
                        <h3 className="mt-6 head text-2xl text-gray-200">Mentorship</h3>
                        <p className="my-4 mb-0 font-normal leading-relaxed tracking-wide text-gray-200">
                    ...
                    <Box className="rounded-md border border-neutral-800 bg-yel/50 p-8 text-center shadow">
                        <h3 className="mt-6 head text-2xl text-gray-200">Learning Center</h3>
                        <p className="my-4 mb-0 font-normal leading-relaxed tracking-wide text-gray-200">
                    ...
                    <Box className="rounded-md border border-neutral-800 bg-yel/50 p-8 text-center shadow">
                        <h3 className="mt-6 head text-2xl text-gray-200">Forum</h3>
                        <p className="my-4 mb-0 font-normal leading-relaxed tracking-wide text-gray-200">
                    ...
                    <Box className="rounded-md border border-neutral-800 bg-yel/50 p-8 text-center shadow">
                        <h3 className="mt-6 head text-2xl text-gray-200">Taskify</h3>
                        <p className="my-4 mb-0 font-normal leading-relaxed tracking-wide text-gray-200">
                    ...
                    <Box className="rounded-md border border-neutral-800 bg-yel/50 p-8 text-center shadow">
                        <h3 className="mt-6 head text-2xl text-gray-200">Community Engagement</h3>
                        <p className="my-4 mb-0 font-normal leading-relaxed tracking-wide text-gray-200">
                ...
                <Box className="absolute bottom-0 left-0 z-0 h-1/3 w-full border-b"
                ...
                <Box className="absolute bottom-0 right-0 z-0 h-1/3 w-full"
